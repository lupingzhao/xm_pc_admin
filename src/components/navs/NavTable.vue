<template>
  <el-table :data="tableData" stripe border style="width: 100%">
    ...
    <el-table-column label="路径" show-overflow-tooltip prop="url" width="300" align="center"></el-table-column>
...
let getData = (current: number, pageSize: number, query: string) => {
  api.getNav({ current: current, pageSize: pageSize, query: query }).
    then((res: any) => {
...
let swich = (e: string, show: boolean) => {
  api.showNav({ id: e, isShow: show }).then((res: any) => {
